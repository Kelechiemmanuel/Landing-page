    ...
    <div>
      <div className="">
        ...
        <div className=" flex flex-col justify-center items-center gap-5">
          <div className='bg-[#2c2d2e] py-10 px-5 rounded-[10px] hover:bg-amber-500 transition-all duration-500 ease-in-out group w-full w-full'>
            <div className='flex justify-between w-full'>
              <h1 className='text-white font-bold text-3xl'>PixelForge Studios</h1>
